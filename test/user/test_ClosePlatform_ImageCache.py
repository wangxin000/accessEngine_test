...
class TestCloseImageCache(unittest.TestCase):
    @classmethod
    def setUpClass(cls):   # 整个测试类只执行一次
         pass

    # 打开图片缓存服务器第三方平台
    def test_close_ImageCache(self):
        request_message_ImageCache = {

            "type": 20004,
            "id": 20,
            "name": "ImageCacheServer"
        ...
        return_message = client.closePlatformAccess(json.dumps(request_message_ImageCache))
