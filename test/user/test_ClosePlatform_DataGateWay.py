...
class TestCloseDataGateWay(unittest.TestCase):
    @classmethod
    def setUpClass(cls):   # 整个测试类只执行一次
         pass

    #打开数据网关第三方平台
    def test_close_DataGateway(self):
            ...
            return_message = client.closePlatformAccess(json.dumps(request_message_DataGateway))
