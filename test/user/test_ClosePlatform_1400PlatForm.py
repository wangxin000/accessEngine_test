...
class TestClose1400PlatForm(unittest.TestCase):
    @classmethod
    def setUpClass(cls):   # 整个测试类只执行一次
         pass

    # 1400视图库平台
    def test_close_1400Platform(self):
        ...
        return_message = client.closePlatformAccess(json.dumps(request_message_1400Platform))
