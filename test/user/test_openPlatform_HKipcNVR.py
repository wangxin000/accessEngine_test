...
class TestOpenHKipcNVR(unittest.TestCase):
    @classmethod
    def setUpClass(cls):   # 整个测试类只执行一次
         pass

    # 海康 IPC、NVR平台
    def test_open_HKipcNVR(self):
        request_message_HKipcNVR = {
            "deviceManage": True,
            "id": 2,
            "ip": "192.168.2.10",
            "name": "hc_ipc",  # 海康 IPC、NVR平台name
            "other": "{\n\t\"userID\" : \"44000000000000000004\"\n}\n",
            "password": "22f92d99bb38238ff3a2c98c11978e25",
            "port": 5022,
            "serverId": "20001",
            "type": 10002,  # 中海康 IPC、NVR type
            "userName": "intellif"
        ...
        return_message = client.openPlatformAccess(json.dumps(request_message_HKipcNVR))
